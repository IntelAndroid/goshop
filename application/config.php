...
return [
    ...
    'cookie' => [
        ...
        'path' => '/',
        // cookie 有效域名
        'domain' => substr($_SERVER['HTTP_HOST'], 3, strlen($_SERVER['HTTP_HOST'])),
        //  cookie 启用安全传输
        'secure' => false,
        // httponly设置
        'httponly' => '1',
    ...
    'http_exception_template' => [
        // 定义404错误的重定向页面地址
        404 => __DIR__ . '../../public/static/404.html',
        // 还可以定义其它的HTTP status
        401 => __DIR__ . '../../public/static/401.html',
    ],
    //以下为静态缓存配置
    'html_cache_on' => false, // 开启静态缓存
    'html_cache_time' =>200, // 全局静态缓存有效期（秒）
